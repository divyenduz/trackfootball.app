...
export type SummaryAthleteSexEnumKey = (typeof summaryAthleteSexEnum)[keyof typeof summaryAthleteSexEnum];
...
export type ActivityTypeEnumKey = (typeof activityTypeEnum)[keyof typeof activityTypeEnum];
...
export type SummaryClubSportTypeEnumKey = (typeof summaryClubSportTypeEnum)[keyof typeof summaryClubSportTypeEnum];
...
export type DetailedAthleteMeasurementPreferenceEnumKey = (typeof detailedAthleteMeasurementPreferenceEnum)[keyof typeof detailedAthleteMeasurementPreferenceEnum];
...
export type DetailedAthlete = (SummaryAthlete & {
    ...
    */
     ...
     * @type string | undefined
    */
    measurement_preference?: DetailedAthleteMeasurementPreferenceEnumKey | undefined;
    /**
...
export type SummarySegmentActivityTypeEnumKey = (typeof summarySegmentActivityTypeEnum)[keyof typeof summarySegmentActivityTypeEnum];
...
export type ExplorerSegmentClimbCategoryDescEnumKey = (typeof explorerSegmentClimbCategoryDescEnum)[keyof typeof explorerSegmentClimbCategoryDescEnum];
...
export type SportTypeEnumKey = (typeof sportTypeEnum)[keyof typeof sportTypeEnum];
...
export type ActivityZoneTypeEnumKey = (typeof activityZoneTypeEnum)[keyof typeof activityZoneTypeEnum];
...
export type DetailedClubMembershipEnumKey = (typeof detailedClubMembershipEnum)[keyof typeof detailedClubMembershipEnum];
...
export type BaseStreamResolutionEnumKey = (typeof baseStreamResolutionEnum)[keyof typeof baseStreamResolutionEnum];
...
export type BaseStreamSeriesTypeEnumKey = (typeof baseStreamSeriesTypeEnum)[keyof typeof baseStreamSeriesTypeEnum];
...
export type ExploreSegmentsQueryParamsActivityTypeEnumKey = (typeof exploreSegmentsQueryParamsActivityTypeEnum)[keyof typeof exploreSegmentsQueryParamsActivityTypeEnum];
...
export type GetActivityStreamsQueryParamsKeysEnumKey = (typeof getActivityStreamsQueryParamsKeysEnum)[keyof typeof getActivityStreamsQueryParamsKeysEnum];
...
export type GetSegmentEffortStreamsQueryParamsKeysEnumKey = (typeof getSegmentEffortStreamsQueryParamsKeysEnum)[keyof typeof getSegmentEffortStreamsQueryParamsKeysEnum];
...
export type GetSegmentStreamsQueryParamsKeysEnumKey = (typeof getSegmentStreamsQueryParamsKeysEnum)[keyof typeof getSegmentStreamsQueryParamsKeysEnum];
